...
namespace Space_Trespassers
{
    class Utilities
    {
        ...
        public static Bitmap RotateImageim(Image image, float angle)
        {
            // center of the image
            float rotateAtX = image.Width / 2;
            float rotateAtY = image.Height / 2;
        ...
        public static Bitmap RotateImageim(Bitmap image, float rotateAtX, float rotateAtY, float angle, bool bNoClip)
        {
            int W, H, X, Y;
            W = image.Width;
            H = image.Height;
